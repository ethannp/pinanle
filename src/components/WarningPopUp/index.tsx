  ...
  return (
    <Styled.Container>
      <Styled.PopUp>
        ...
        <Styled.Section>
          <p>
            <a href={hrefText} target="_blank" rel="noreferrer">
              Click here
            </a>{" "}
            to send me an email and let me know! Alternatively, contact me on
            Discord at <code style={{ fontSize: "16px" }}>fluff#2368</code>.
          </p>
        </Styled.Section>
        <Styled.Section>
          <p>
        ...
        <Styled.Section>
          <p>Today is Pinanle #{index}.</p>
        </Styled.Section>
        <a
          href="https://github.com/ethannp/pinanle"
          target="_blank"
          rel="noreferrer"
        >
